...
const Login = () => {
  ...
  return (
    <section className="min-h-screen w-full flex items-center justify-center  bg-linear-to-br from-[#031700] to-[#001a16] p-4 text-slate-800 font-sans">
      <div className="flex flex-col md:flex-row w-full max-w-sm md:max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 md:h-125">
...
text-[#4cd497]  transition-all duration-500 rounded-r-full top-40 h-12"
          />
          <Link
            to="/login"
            className="flex flex-col items-center gap-2 mb-10 text-[#60d44c]"
          >
          ...
          <Link
            to="/signup"
            className="flex flex-col items-center gap-2 text-slate-400 hover:text-green-900 transition-colors"
          >
        ...
        >
          <div className="w-full p-8 md:p-12 flex flex-col justify-center">
            <h1 className="text-2xl font-bold mb-10 text-center text-slate-900">
              Sign In
            </h1>
            <div className="space-y-4">
              ...
              <Link to="/reset">
                <p className="text-slate-500 text-sm hover:text-amber-500 mt-2">
                  Forgot Password?
                </p>
              </Link>
              <button
